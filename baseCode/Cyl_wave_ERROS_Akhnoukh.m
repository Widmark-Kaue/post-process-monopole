...
RMS_8ppw = dissip(Simulation8,r);
RMS_16ppw = dissip(Simulation16,r);
RMS_32ppw = dissip(Simulation32,r);
RMS_64ppw = dissip(Simulation64,r);
...
RMS_Backward10 = dissip(pBackward10,r);
RMS_Backward20 = dissip(pBackward20,r);
RMS_Backward40 = dissip(pBackward40,r);
RMS_Backward80 = dissip(pBackward80,r);
RMS_Backward4000 = dissip(pBackward4000,r);
...
RMS_Euler10 = dissip(pEuler10,r);
RMS_Euler20 = dissip(pEuler20,r);
RMS_Euler40 = dissip(pEuler40,r);
RMS_Euler80 = dissip(pEuler80,r);
RMS_Euler4000 = dissip(pEuler4000,r);
...
RMS_limitedLinear16 = dissip(pLimited16ppw,r);
RMS_limitedLinear32 = dissip(pLimited32ppw,r);
RMS_linearUpwind16 = dissip(pLinearUpwind16ppw,r);
RMS_linearUpwind32 = dissip(pLinearUpwind32ppw,r);
RMS_Upwind16 = dissip(pUpwind16ppw,r);
RMS_Upwind32 = dissip(pUpwind32ppw,r);
RMS_vanLeer16 = dissip(pVanLeer16ppw,r);
RMS_vanLeer32 = dissip(pVanLeer32ppw,r);
...
%     legend('Analítico', 'Direto', 'Location','best');
    ...
    % Erro
    G_sim = p_sim(100)/p_sim(101);
    G_analitico = p_2_E(100)/p_2_E(101);
    Erro_diss = abs(G_sim)/abs(G_analitico);
end 